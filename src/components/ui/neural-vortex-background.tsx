...
const NeuralVortexBackground: React.FC<NeuralVortexBackgroundProps> = ({ className }) => {
  ...
  return (
    <canvas 
      ref={canvasRef} 
      className={cn("fixed inset-0 w-full h-full pointer-events-none opacity-50 z-0", className)}
    />
  );
};
